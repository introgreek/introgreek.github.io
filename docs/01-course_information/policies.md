...
You are expected to abide by Fairfield’s Honor Code and its tenets of Academic Honesty, posted [here](https://www.fairfield.edu/academics/academic-support/). Cheating on homework, assignments, quizzes, or exams (defined here as but not limited to reproducing answers from an answer key, referring to forbidden notes to help answer questions, copying another student’s answers, or using AI to generate assignment answers [see below]) may result in penalties ranging from a failure on the specific assignment to failure for the entire course.
...
<ins>Types of AI covered by this policy</ins>: any automatic translation services that render Latin into English and vice versa (including but not limited to Google Translate and Apple Translate) and interfaces that respond to user-generated prompts (including but not limited to ChatGPT, Microsoft Copilot, Apple Siri, and Google Gemini).

<ins>Prohibited use</ins>: You may ***not*** use AI:
* to *generate* any content for inclusion in your assignment submissions, including but not limited to answers on open-note assignments, Greek vocabulary and inflected forms, responses to articles or videos, and analyses of Greek or English passages.
* to *produce* vocabulary items or paradigm charts for any part of speech; all vocabulary and word endings must come from our course website [https://introgreek.github.io](https://introgreek.github.io), reputable websites, or resources disseminated in class (we will discuss what constitutes a reputable website or reliable source in class).
* to *check* the accuracy of your answers on open-note assignments.
* to *check* the spelling of written <ins>Greek</ins> expressions.
* to *format or reword* an assignment that you have already generated on your own. For example, you may not use AI on text that you have already written to change text styles (italics, bold, etc.), to add summaries, or to create synonyms.

<ins>Permitted use</ins>: AI may be used:
* to *check* the spelling of written English expressions.

<ins>Disclosure and non-compliance</ins>: If you use AI in a permitted capacity on any assignment, **you are required to add a statement to the end of the assignment that discloses which type of AI you used and what specific tasks you used AI to complete**. At all times, you are expected to maintain academic honesty and integrity in all your assignment submissions. Any violation of the guidelines above will be considered a violation of academic integrity and adjudicated according to Fairfield University’s policies. Each violation will be communicated immediately to the dean upon detection. If you are not sure whether a certain practice violates the guidelines above, **please ask me about it before submitting the assignment in question** to avoid being penalized.
...
In addition to my email and student hours, there are resources outside myself, like the [Office of Academic Support and Retention](https://www.fairfield.edu/academics/academic-support/) and the [Writing Center](https://www.fairfield.edu/academics/academic-support/writing-math-and-science-centers/) that can help with assignments or your progress through the course in general. Remember, there is no such thing as a stupid question.

By the way, to test whether you’re reading the syllabus all the way through, please send me an email with a photo of your favorite ancient Greek letter of the alphabet by Monday, January 26, at 9:30am, with the subject line “It’s all GREEK to me!” If you do so, you will receive five (5) extra credit points on your semester total (see [Grading](grading) for the course grading structure).
...
If you would like to discuss the matter confidentially, [this website](https://www.fairfield.edu/about/offices-and-departments/dean-of-students/student-handbook/sex-based-harassment-discrimination-and-retaliation-policy/index.html) lists confidential resources that are available to you under section 19a.

[Return to top.](#top)

***

## Important Course University Deadlines

* **Monday, January 26, 2026**: end of add/drop period
* **Monday, February 2, 2026**: deadline for Full-Time Undergraduates Withdrawal, 90% Refund
* **Monday, February 9, 2026**: deadline for Full-Time Undergraduates Withdrawal, 60% Refund
* **Monday, February 16, 2026**: deadline for Full-Time Undergraduates Withdrawal, 40% Refund
* **Monday, February 23, 2026**: deadline for Full-Time Undergraduates Withdrawal, 20% Refund
* **Wednesday, March 25, 2026**: deadline for Full-Time Undergraduates Withdrawal ***and*** deadline to declare Credit/No Credit Course