...
Ancient Greek verbs can appear in three different forms, including **infinitives** (verbal nouns, like "to make" or "to do") or **participles** (verbal adjectives, like "making" or "done"). For this semester, however, we'll be focusing mostly on verbs that are **conjugated** (more on this in a bit).
...
<br><br>
3. **tense**. The **tense** of a verb indicates *when* the action of the verb occurs. Focus for now on the first two, as they are the tenses on which we will focus this semester. The final two (pluperfect and future perfect) are relatively rare, especially in comparison to the first five.
...
* δείκνυμι, δείξω, ἔδειξα, δέδειχα, δέδειγμα, ἐδείχθην, "[to show](https://logeion.uchicago.edu/δείκνυμι)"
...
* ἔχω, ἕξω / σχήσω, ἔσχον, ἔσχηκα, --, --, "[to have, hold](https://logeion.uchicago.edu/ἔχω)"

This verb does not have a fifth or sixth principal part.
