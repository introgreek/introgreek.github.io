...
In Greek, the aorist tense of a verb is formed using the **third** or **sixth** principal part: the **third** helps us form the **active voice** ("she showed") and **middle voice** ("she showed for herself"), while the **sixth** helps us form the **passive voice** ("she was shown"). We'll focus for the first two thirds of this semester on the **aorist active and middle** -- therefore, we'll be working primarily with the **third** principal part in terms of conjugation.
