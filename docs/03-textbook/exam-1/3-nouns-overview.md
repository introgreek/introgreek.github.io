...
1\. <ins>**gender**</ins>: A Greek noun can exhibit one of three grammatical genders:
* **masculine**
* **feminine** 
* **neuter** 
...
2\. <ins>**case**</ins>: A Greek noun can exhibit one of five cases: 
* **nominative**
* **genitive**
* **dative**
* **accusative**
...
3\. <ins>**number**</ins>: A Greek noun can exhibit one of three numbers: 
* **singular** (if there's only one of the noun)
* **plural** (if there's more than one of the noun)
* **dual** (if there are exactly two of the noun; the dual becomes progressively rarer the further in time we progress, but it tends to be used with natural pairs like eyes or knees in early works like the *Iliad* and the *Odyssey*). 
...
In Greek, the **definite article** is used with a noun to indicate that we're talking about a specific noun. Its translation defaults to the English "the", but it can also be used to indicate possession (e.g., ἡ γνώμη [γνώμη, γνώμης, f. - opinion, thought] = "the opinion" or "my/your/their [etc.] opinion") or stand alone as a pronoun (on which we'll learn more in the unit on pronouns).
